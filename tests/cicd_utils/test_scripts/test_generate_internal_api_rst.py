...
def test_generate_module_rst_with_submodules() -> None:
    ...
    content = generate_module_rst(
        "_color", 
        ["_color.utils", "_color.css_colors"]
    )
...
def test_get_module_description() -> None:
    ...
    assert get_module_description("ridgeplot._color.utils") == "Color manipulation and conversion functions."